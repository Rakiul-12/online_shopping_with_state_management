...
class MyInputDecorationTheme{
 ...
 static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
   ...
   prefixIconColor: Mycolors.darkGrey,
   suffixIconColor: Mycolors.darkGrey,
   labelStyle: const TextStyle().copyWith(fontSize: Mysize.fontSizeMd, color: Mycolors.white),
   hintStyle: const TextStyle().copyWith(fontSize: Mysize.fontSizeSm, color: Mycolors.white),
