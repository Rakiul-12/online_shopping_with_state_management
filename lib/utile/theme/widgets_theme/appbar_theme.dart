...
class MyAppBarTheme{
  ...
  static final lightAppBarTheme = AppBarTheme(
    ...
    actionsIconTheme: const IconThemeData(color: Mycolors.black, size: Mysize.iconMd),
    titleTextStyle: const TextStyle(fontSize: 18.0, fontWeight: FontWeight.w600, color: Mycolors.black),
  );
