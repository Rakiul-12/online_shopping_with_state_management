...
class OrderModel{
  ...
  String get formattedOrderDate => MyHelperFunction.getFormattedDate(orderDate);

  String get formattedDeliveryDate => MyHelperFunction.getFormattedDate(deliveryDate!);
