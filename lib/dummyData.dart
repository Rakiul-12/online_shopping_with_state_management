...
class MyDummyData {
  ...
  static final List<CategoryModel> categories = [
    /// Parent Categories
    CategoryModel(id: '1', name: 'Clothes', image: MyImage.clothesIcon, isFeatured: true),
    CategoryModel(id: '2', name: 'Shoes', image: MyImage.shoesIcon, isFeatured: true),
    CategoryModel(id: '3', name: 'Cosmetics', image: MyImage.cosmeticsIcon, isFeatured: true),
    CategoryModel(id: '4', name: 'Electronics', image: MyImage.electronicsIcon, isFeatured: true),
    CategoryModel(id: '5', name: 'Furniture', image: MyImage.furnitureIcon, isFeatured: true),
    CategoryModel(id: '6', name: 'Sports', image: MyImage.sportsIcon, isFeatured: true),

    /// Clothes
    CategoryModel(id: '7', name: 'Shirts', image: MyImage.shirtIcon, parentId: '1'),
    CategoryModel(id: '8', name: 'Jackets', image: MyImage.jacketsIcon, parentId: '1'),
    CategoryModel(id: '9', name: 'Shorts', image: MyImage.shortsIcon, parentId: '1'),

    /// Shoes
    CategoryModel(id: '10', name: 'Formal Shoes', image: MyImage.formalShoesIcon, parentId: '2'),
    CategoryModel(id: '11', name: 'Sports Shoes', image: MyImage.sportsShoesIcon, parentId: '2'),

    /// Cosmetics
    CategoryModel(id: '12', name: 'Face', image: MyImage.faceIcon, parentId: '3'),
    CategoryModel(id: '13', name: 'Hair Oils', image: MyImage.hairOilIcon, parentId: '3'),
    CategoryModel(id: '14', name: 'Bags', image: MyImage.bagsIcon, parentId: '3'),
    CategoryModel(id: '15', name: 'Perfumes', image: MyImage.perfumeIcon, parentId: '3'),
    CategoryModel(id: '16', name: 'Watches', image: MyImage.watchIcon, parentId: '3'),

    /// Electronics
    CategoryModel(id: '17', name: 'Gadgets', image: MyImage.gadgetsIcon, parentId: '4', isFeatured: false),
    CategoryModel(id: '18', name: 'Laptops', image: MyImage.laptopsIcon, parentId: '4', isFeatured: false),
    CategoryModel(id: '19', name: 'Mobiles', image: MyImage.mobileIcon, parentId: '4', isFeatured: false),

    /// Furniture
    CategoryModel(id: '20', name: 'Bed', image: MyImage.bedIcon, parentId: '5', isFeatured: false),
    CategoryModel(id: '21', name: 'Lamps', image: MyImage.lampIcon, parentId: '5', isFeatured: false),

    /// Sports
    CategoryModel(id: '22', name: 'Cricket', image: MyImage.cricketIcon, parentId: '6', isFeatured: false),
    CategoryModel(id: '23', name: 'Soccer', image: MyImage.soccerIcon, parentId: '6', isFeatured: false),
  ];


  // List of all brands
  static final List<BrandModel> brands = [
    BrandModel(id: "1", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171937/Brand%20folder/rt86m7mbc5bl5tu6mlze.png", name: "Nike", productsCount: 6, isFeatured: true),
    BrandModel(id: "2", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171939/Brand%20folder/kjpke1wq8dus2tdrr9v4.jpg", name: "Adidas", productsCount: 7, isFeatured: true),
    BrandModel(id: "3", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171940/Brand%20folder/npodwkwaunnaoonuk0ji.jpg", name: "Apple", productsCount: 6, isFeatured: true),
    BrandModel(id: "4", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171942/Brand%20folder/bd39vqr50x3wwo6ljykx.png", name: "Bata", productsCount: 1, isFeatured: true),
    BrandModel(id: "5", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171943/Brand%20folder/aeooobaxtsyip3gewunz.png", name: "Bloody", productsCount: 4, isFeatured: false),
    BrandModel(id: "6", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171944/Brand%20folder/rbjgjgwykaaz35t0eyn6.jpg", name: "Breakout", productsCount: 3, isFeatured: true),
    BrandModel(id: "7", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171945/Brand%20folder/t4pbmp0ytnmzwl2ugq63.png", name: "Dari Mooch", productsCount: 3, isFeatured: true),
    BrandModel(id: "8", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171947/Brand%20folder/mqbhqg9udouitor0inkq.jpg", name: "Inter Wood", productsCount: 5, isFeatured: false),
    BrandModel(id: "9", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171948/Brand%20folder/vnjk9otzjogtzjppzopt.jpg", name: "HP", productsCount: 7, isFeatured: false),
    BrandModel(id: "10", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171949/Brand%20folder/vi8pk6fodybaafczyt6z.png", name: "NDURE", productsCount: 2, isFeatured: true),
    BrandModel(id: "11", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171950/Brand%20folder/vx6lyph9wxne9fhltwi8.png", name: "J", productsCount: 2, isFeatured: true),
    BrandModel(id: "12", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171951/Brand%20folder/v9mf6v6c12d5x5jtlmhh.jpg", name: "NorthStar", productsCount: 2, isFeatured: true),
    BrandModel(id: "13", image: "https://res.cloudinary.com/diumcbq4a/image/upload/v1758171952/Brand%20folder/vnjmjuh8sf0huzwbc0tb.png", name: "Polo", productsCount: 2, isFeatured: true),
  ];
  ...
  static final List<ProductModel> products = [
    ...
    ProductModel(
        ...
        stock: 15,
        price: 115,
        thumbnail: MyImage.productImage1,
        description:
    ...
    ProductModel(
        ...
        price: 30,
        isFeatured: true,
        thumbnail: MyImage.productImage2,
        description:
    ...
    ProductModel(
        ...
        price: 700,
        isFeatured: false,
        thumbnail: MyImage.productImage3,
        description:
    ...
    ProductModel(
        ...
        price: 350,
        isFeatured: true,
        thumbnail: MyImage.productImage4a,
        description:
        ...
        brand: brands[2],
        images: [MyImage.productImage4b, MyImage.productImage4c, MyImage.productImage4d, MyImage.productImage4e],
        sku: 'ABR4568',
        categoryId: '19',
        productAttributes: [
    ...
    ProductModel(
        ...
        price: 60,
        isFeatured: false,
        thumbnail: MyImage.productImage5,
        description:
    ...
    ProductModel(
        ...
        stock: 0,
        price: 50,
        thumbnail: MyImage.productImage6,
        description:
    ...
    ProductModel(
      ...
      price: 70,
      isFeatured: true,
      thumbnail: MyImage.productImage7,
      //16/512
      description:
    ...
    ProductModel(
      ...
      stock: 50,
      price: 55.99,
      thumbnail: MyImage.productImage8,
      description:
    ...
    ProductModel(
      ...
      salePrice: 7.99,
      price: 8.99,
      thumbnail: MyImage.productImage9,
      description:
    ...
    ProductModel(
        ...
        brand: brands[3],
        thumbnail: MyImage.productImage10,
        description:
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage11,
      sku: 'BATA-SOCKS',
      categoryId: '9',
      isFeatured: true,
      brand: brands[3],
    ...
    ProductModel(
        ...
        stock: 10,
        price: 4.99,
        thumbnail: MyImage.productImage12,
        description:
    ...
    ProductModel(
        ...
        price: 39.99,
        stock: 23,
        thumbnail: MyImage.productImage13,
        description:
    ...
    ProductModel(
        ...
        stock: 3,
        salePrice: 87.99,
        thumbnail: MyImage.productImage14,
        description:
    ...
    ProductModel(
        ...
        stock: 54,
        salePrice: 47.99,
        thumbnail: MyImage.productImage15,
        description:
    ...
    ProductModel(
      ...
      price: 79.99,
      salePrice: 71.99,
      thumbnail: MyImage.productImage16a,
      images: [MyImage.productImage16b],
      stock: 153,
      description:
    ...
    ProductModel(
      ...
      stock: 19,
      brand: brands[5],
      thumbnail: MyImage.productImage17,
      description:
    ...
    ProductModel(
        ...
        price: 29.99,
        salePrice: 23.99,
        thumbnail: MyImage.productImage18,
        stock: 12,
        brand: brands[5],
        categoryId: '7',
        description:
    ...
    ProductModel(
      ...
      price: 59.99,
      salePrice: 49.99,
      thumbnail: MyImage.productImage19a,
      images: [MyImage.productImage19b],
      stock: 12,
      brand: brands[10],
      categoryId: '10',
      description:
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage20,
      price: 44.99,
      salePrice: 39.99,
      stock: 43,
      brand: brands[3],
    ...
    ProductModel(
        ...
        thumbnail: MyImage.productImage21,
        price: 89.99,
        salePrice: 78.87,
        categoryId: '7',
        brand: brands[1],
    ...
    ProductModel(
        ...
        salePrice: 969.99,
        stock: 2,
        thumbnail: MyImage.productImage22,
        brand: brands[8],
        categoryId: '18',
        productType: 'ProductType.variable',
        description:
    ...
    ProductModel(
        ...
        price: 1099,
        salePrice: 999.99,
        thumbnail: MyImage.productImage23,
        description:
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage24,
      price: 59.99,
      salePrice: 48.99,
      stock: 43,
      brand: brands[9],
    ...
    ProductModel(
      ...
      price: 29.99,
      salePrice: 26.99,
      thumbnail: MyImage.productImage25,
      stock: 23,
      brand: brands[5],
      description:
    ...
    ProductModel(
      ...
      price: 49.99,
      salePrice: 44.99,
      thumbnail: MyImage.productImage26,
      stock: 23,
      brand: brands[7],
      description:
    ...
    ProductModel(
        ...
        price: 12.99,
        thumbnail: MyImage.productImage27,
        brand: brands[6],
        description:
    ...
    ProductModel(
        ...
        thumbnail: MyImage.productImage28,
        stock: 3,
        price: 8.99,
        salePrice: 7.76,
        description:
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage29,
      stock: 3,
      price: 9.99,
      salePrice: 7.56,
      description:
    ...
    ProductModel(
        ...
        thumbnail: MyImage.productImage30,
        stock: 3,
        price: 29.99,
        salePrice: 27.99,
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage31,
      price: 69.99,
      salePrice: 52.99,
      stock: 2,
      description:
    ...
    ProductModel(
        ...
        thumbnail: MyImage.productImage32,
        price: 499.99,
        salePrice: 475.99,
        stock: 3,
        productType: 'ProductType.variable',
    ...
    ProductModel(
        ...
        price: 849,
        thumbnail: MyImage.productImage33a,
        images: [MyImage.productImage33b, MyImage.productImage33c, MyImage.productImage33d],
        description:
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage34,
      price: 1399.99,
      salePrice: 1268.99,
      stock: 76,
      description:
    ...
    ProductModel(
      ...
      price: 1599,
      thumbnail: MyImage.productImage35,
      salePrice: 1497.99,
      stock: 29,
      description:
    ...
    ProductModel(
        ...
        price: 14.99,
        thumbnail: MyImage.productImage36,
        stock: 3,
        productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage37,
      brand: brands[4],
      categoryId: '17',
      sku: "KEYBOARD-BLOODY",
    ),
    ...
    ProductModel(
        ...
        salePrice: 1133.99,
        stock: 34,
        thumbnail: MyImage.productImage38a,
        images: [MyImage.productImage38b, MyImage.productImage38c],
        productType: 'ProductType.variable',
        categoryId: '18',
        sku: "LAPTOP-HP",
        brand: brands[8],
    ...
    ProductModel(
        ...
        salePrice: 899,
        stock: 2,
        thumbnail: MyImage.productImage39,
        productType: 'ProductType.variable',
        categoryId: '18',
        sku: "LAPTOP-HP",
        brand: brands[8],
    ...
    ProductModel(
        ...
        thumbnail: MyImage.productImage40,
        productType: 'ProductType.single',
        stock: 2,
        price: 399.99,
        salePrice: 375.99,
    ...
    ProductModel(
      ...
      salePrice: 144.99,
      stock: 22,
      thumbnail: MyImage.productImage41,
      description:
    ...
    ProductModel(
      ...
      price: 179.99,
      thumbnail: MyImage.productImage42,
      stock: 23,
      brand: brands[4],
      description:
    ...
    ProductModel(
        ...
        thumbnail: MyImage.productImage43,
        stock: 21,
        price: 479.99,
        salePrice: 452.99,
        productType: 'ProductType.single',
    ...
    ProductModel(
        ...
        thumbnail: MyImage.productImage44,
        stock: 21,
        price: 49.99,
        productType: 'ProductType.single',
        categoryId: '17',
    ...
    ProductModel(
        ...
        thumbnail: MyImage.productImage45a,
        images: [MyImage.productImage45b],
        stock: 21,
        price: 29.99,
        salePrice: 28.99,
        productType: 'ProductType.variable',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage46,
      stock: 21,
      price: 39.99,
      salePrice: 37.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage47,
      stock: 21,
      price: 39.99,
      productType: 'ProductType.single',
      categoryId: '11',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage48,
      stock: 21,
      price: 59.99,
      salePrice: 52.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
        ...
        thumbnail: MyImage.productImage49a,
        images: [MyImage.productImage49b],
        stock: 21,
        price: 89.99,
        salePrice: 84.99,
        productType: 'ProductType.variable',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage50,
      stock: 21,
      price: 499.99,
      salePrice: 456.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage51,
      stock: 21,
      price: 599.99,
      salePrice: 576.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage52,
      stock: 21,
      price: 89.99,
      salePrice: 75.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage53,
      stock: 21,
      price: 399.99,
      salePrice: 376.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage54,
      stock: 2,
      price: 60,
      productType: 'ProductType.single',
      categoryId: '17',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage55,
      stock: 2,
      price: 299.99,
      salePrice: 275.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage56,
      stock: 2,
      price: 180,
      salePrice: 177,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage57,
      stock: 2,
      price: 49,
      productType: 'ProductType.single',
      categoryId: '8',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage58,
      stock: 2,
      price: 799.99,
      salePrice: 743.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage59,
      stock: 2,
      price: 1299,
      salePrice: 743.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage60,
      stock: 2,
      price: 999,
      productType: 'ProductType.single',
      categoryId: '20',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage61,
      stock: 2,
      price: 129,
      salePrice: 127,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage62,
      stock: 2,
      price: 259,
      productType: 'ProductType.single',
      categoryId: '21',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage63,
      stock: 2,
      price: 249,
      salePrice: 212,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage64,
      stock: 2,
      price: 155,
      salePrice: 128,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage65,
      stock: 2,
      price: 620,
      salePrice: 615,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage66,
      stock: 2,
      price: 15,
      productType: 'ProductType.single',
      categoryId: '8',
    ...
    ProductModel(
        ...
        thumbnail: MyImage.productImage67a,
        images: [MyImage.productImage67b, MyImage.productImage67c],
        stock: 2,
        price: 8,
        productType: 'ProductType.variable',
        categoryId: '7',
    ...
    ProductModel(
      ...
      thumbnail: MyImage.productImage68,
      stock: 2,
      price: 27,
      productType: 'ProductType.single',
      categoryId: '9',
